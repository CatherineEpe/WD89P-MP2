...
app.use(cors());
  ...
  const connection = mysql.createConnection({
    ...
    database: "my_capstone" // our database name
  });
...
app.post('/login', function (request, response) {
    ...
    //the front end.
    const myQuery = `SELECT * FROM my_capstone.login_register where username = "${usernameFromFrontEnd}"`;
...
app.post('/register', function (request, response) {
   ...
   const myQuery = `INSERT INTO my_capstone_register (lrn, email, username, password) VALUES 
